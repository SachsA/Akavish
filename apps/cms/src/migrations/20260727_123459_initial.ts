...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_games_platform" AS ENUM('PC', 'PlayStation', 'Xbox', 'Nintendo Switch', 'Mobile');
  CREATE TYPE "public"."enum_games_genre" AS ENUM('FPS', 'RPG', 'Action', 'Strategy', 'Sports', 'MOBA', 'Battle Royale', 'MMO', 'Simulation', 'Other');
  CREATE TYPE "public"."enum_articles_category" AS ENUM('news', 'leak', 'review', 'preview', 'conference', 'esport');
  CREATE TYPE "public"."enum_articles_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_version_category" AS ENUM('news', 'leak', 'review', 'preview', 'conference', 'esport');
  ...
  ALTER TABLE "games_platform" ADD CONSTRAINT "games_platform_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "games_genre" ADD CONSTRAINT "games_genre_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_articles_v" ADD CONSTRAINT "_articles_v_version_game_id_games_id_fk" FOREIGN KEY ("version_game_id") REFERENCES "public"."games"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "games_platform_order_idx" ON "games_platform" USING btree ("order");
  CREATE INDEX "games_platform_parent_idx" ON "games_platform" USING btree ("parent_id");
  CREATE INDEX "games_genre_order_idx" ON "games_genre" USING btree ("order");
  CREATE INDEX "games_genre_parent_idx" ON "games_genre" USING btree ("parent_id");
  ...
  CREATE INDEX "articles_game_idx" ON "articles" USING btree ("game_id");
  ...
  CREATE INDEX "_articles_v_version_version_game_idx" ON "_articles_v" USING btree ("version_game_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "games_platform" CASCADE;
  DROP TABLE "games_genre" CASCADE;
  ...
  DROP TYPE "public"."enum_games_platform";
  DROP TYPE "public"."enum_games_genre";
